...
pretrained = AutoModelForCausalLM.from_pretrained("state-spaces/mamba-130m-hf")
...
tokenizer.push_to_hub("voidful/mamba-130m-base")
pretrained.push_to_hub("voidful/mamba-130m-base")
