...
pretrained = AutoModelForCausalLM.from_pretrained("microsoft/phi-2")
...
pretrained.config.rope_theta = 50000.0
pretrained.config.max_position_embeddings = 2048
pretrained.config.rope_scaling = {"type": "dynamic", "factor": 16.00}

tokenizer.push_to_hub("voidful/phi-2_base")
pretrained.push_to_hub("voidful/phi-2_base")
